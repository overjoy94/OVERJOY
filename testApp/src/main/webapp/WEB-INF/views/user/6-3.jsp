		...
		<div class="col-md-3 work-us-left">
			...
			<div class="col-md-9 work-us-left">
				...
				<br><br><br>
					 ...
					 <!-- <form name="regist" method="post" onsubmit="return regist_check()"> -->
					 
					<!--  <form name="regist" method="post" onsubmit="return regist_check()" action="/userInsert"> -->
					   ...
					   <table width="940" style="padding:5px 0 5px 0; ">
					       ...
					       <tr>
					         ...
					         <td><input type="text" name="userid" id="userid" maxlength="16">
					          <input type="button" name="checkbtn" id="checkbtn" value="중복체크"></td> <!--  OnClick="openConfirmId(this.form) -->

					       </tr>
					       <tr>
					         <th>*비밀번호</th>
					         <td><input type="password" name="upw1" id="upw1" maxlength="20"> 대문자와 소문자를 포함한 영어알파벳과 숫자, 특수문자를 포함해주세요</td>
					       </tr>
					       <tr>
					         <th>*비밀번호 확인</th>
					         <td><input type="password" name="upw2" id="upw2" maxlength="20"></td>
					       </tr>
							 <tr>
					       ...
					       <tr>
							...
							<tr>
							 ...
							 <tr>
								<th>*생년월일</th>
								<td>
								<select name="YEAR" id="YEAR" title="년도" value="1994"></select>    
								<select name="MONTH" id="MONTH" title="월" value="01"></select>
								<select name="DAY" id="DAY" title="일" value="02"></select>
								</td>
									<script>
										$(document).ready(function(){
											DateBox();
