...
# 날짜 형식 변경
회원가입// alter session set nls_date_format='YYYY-MM-DD'
alter session set nls_date_format ='DD-MON-YYYY HH24:MI:DD'
티켓 // alter session set nls_date_format ='YYYY-MM-DD HH24:MI'
 

insert into movie_user values('손동민', 'son', '1234', 'email', 'pq', 'pa', 'phone', 'pzip', '1234','address','detail', '1994-01-01','male', 100000);	
...
insert into movie_info values('극한직업', '2019-02-27', '2019-05-27', 'images/one.jpg' ,3);
...
insert into movie_ticket
values('1','son','극한직업',sysdate,'2019-03-11 07:00',8000,3,null);
insert into movie_ticket 
values('2','son','드래곤 길들이기','2019-02-26 12:00','2019-02-28 07:00',8000,4,null);
insert into movie_ticket 
values('3','son','극한직업','2019-02-28 12:00','2019-04-02 11:40',10000,4,'good');
insert into movie_ticket 
values('4','son','극한직업','2019-02-28 12:00','2019-05-08 11:40',10000,4,'good');
insert into movie_ticket 
values('6','son','극한직업','2019-02-27 12:00','2019-06-08 07:00',8000,null,null);
insert into movie_ticket 
values('7','son','극한직업','2019-02-24 12:00','2019-07-09 11:40',10000,3,'good');
insert into movie_ticket 
values('8','son','극한직업','2019-02-27 12:00','2019-08-28 07:00',8000,null,null);
insert into movie_ticket 
values('9','son','극한직업','2019-02-27 12:00','2019-09-02 07:00',8000,null,null);
...
# 날짜 검색
select * from movie_info where '2019-3-24' between play_start and play_end;
