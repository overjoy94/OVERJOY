...
public class EtcController {
	...
	public String faqRegister(@ModelAttribute("faqVO") FaqVO faqVO,Model model, HttpServletRequest request) {	
		 etcService.faqRegister(faqVO);
		return "redirect:faq";
	}
	...
	@RequestMapping(value = "/qnk", method = RequestMethod.GET )
	public String qnk(Model model) {				
		return "etc/5-3";
	}*/
